...
#include <jni.h>
/* Header for class io_github_robolib_jni_AccelerometerJNI */

#ifndef _Included_io_github_robolib_jni_AccelerometerJNI
#define _Included_io_github_robolib_jni_AccelerometerJNI
#ifdef __cplusplus
extern "C" {
#endif
/*
