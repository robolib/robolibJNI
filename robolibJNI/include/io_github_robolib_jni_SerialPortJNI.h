...
#include <jni.h>
/* Header for class io_github_robolib_jni_SerialPortJNI */

#ifndef _Included_io_github_robolib_jni_SerialPortJNI
#define _Included_io_github_robolib_jni_SerialPortJNI
#ifdef __cplusplus
extern "C" {
#endif
/*
