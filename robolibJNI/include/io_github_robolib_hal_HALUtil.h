...
#include <jni.h>
/* Header for class io_github_robolib_hal_HALUtil */

#ifndef _Included_io_github_robolib_hal_HALUtil
#define _Included_io_github_robolib_hal_HALUtil
#ifdef __cplusplus
extern "C" {
#endif
#undef io_github_robolib_hal_HALUtil_NULL_PARAMETER
#define io_github_robolib_hal_HALUtil_NULL_PARAMETER -1005L
#undef io_github_robolib_hal_HALUtil_SAMPLE_RATE_TOO_HIGH
#define io_github_robolib_hal_HALUtil_SAMPLE_RATE_TOO_HIGH 1001L
#undef io_github_robolib_hal_HALUtil_VOLTAGE_OUT_OF_RANGE
#define io_github_robolib_hal_HALUtil_VOLTAGE_OUT_OF_RANGE 1002L
#undef io_github_robolib_hal_HALUtil_LOOP_TIMING_ERROR
#define io_github_robolib_hal_HALUtil_LOOP_TIMING_ERROR 1004L
#undef io_github_robolib_hal_HALUtil_INCOMPATIBLE_STATE
#define io_github_robolib_hal_HALUtil_INCOMPATIBLE_STATE 1015L
#undef io_github_robolib_hal_HALUtil_ANALOG_TRIGGER_PULSE_OUTPUT_ERROR
#define io_github_robolib_hal_HALUtil_ANALOG_TRIGGER_PULSE_OUTPUT_ERROR -1011L
#undef io_github_robolib_hal_HALUtil_NO_AVAILABLE_RESOURCES
#define io_github_robolib_hal_HALUtil_NO_AVAILABLE_RESOURCES -104L
#undef io_github_robolib_hal_HALUtil_PARAMETER_OUT_OF_RANGE
#define io_github_robolib_hal_HALUtil_PARAMETER_OUT_OF_RANGE -1028L
/*
