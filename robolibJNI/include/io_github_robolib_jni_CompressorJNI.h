...
#include <jni.h>
/* Header for class io_github_robolib_jni_CompressorJNI */

#ifndef _Included_io_github_robolib_jni_CompressorJNI
#define _Included_io_github_robolib_jni_CompressorJNI
#ifdef __cplusplus
extern "C" {
#endif
/*
