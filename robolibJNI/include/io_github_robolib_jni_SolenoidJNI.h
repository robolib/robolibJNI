...
#include <jni.h>
/* Header for class io_github_robolib_jni_SolenoidJNI */

#ifndef _Included_io_github_robolib_jni_SolenoidJNI
#define _Included_io_github_robolib_jni_SolenoidJNI
#ifdef __cplusplus
extern "C" {
#endif
/*
